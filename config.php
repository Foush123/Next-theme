...
$THEME->name = 'next_theme';

$THEME->sheets = ['custom', 'dashboard'];
...
$THEME->csspostprocess = 'theme_next_theme_process_css';
...
$THEME->scss = function($theme) {
    return  theme_next_theme_get_main_scss_content($theme);
};
$THEME->prescsscallback = 'theme_next_theme_get_pre_scss';

$THEME->extrascsscallback = 'theme_next_theme_get_extra_scss';
