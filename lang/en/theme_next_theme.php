...
$string['backgroundimage_desc'] = 'The image to display as the background for the site\'s theme. <br> <b> Note: </b> The background image works based on the parent theme "Boost". If the background image is deleted in the "Boost" theme, it will also be deleted in our "Next Theme" theme.';
$string['blockemptymessage'] = '<p><i class="fa fa-info-circle"></i> This feature setting is enabled but not properly configured. Please review and configure it promptly.</p>';
...
$string['content_desc'] = 'To set the content for the this block, enter the block content as plain text or use the "lang" prefix followed by the appropriate "language_key" for multi-lingual support. You can find the theme language keys for multi-lingual support in the "/theme/next_theme/lang/en/theme_next_theme.php" file.';
...
$string['footerbtitledesc'] = 'Enter a title for this block as plain text or lang:language_key for multi-lingual support. You can find the theme language keys here: /theme/next_theme/lang/en/theme_next_theme.php';
...
$string['icondesc'] = 'Enter the name of the icon you wish to use.  List is <a href="https://fontawesome.com/v4/cheatsheet/" target="_new">here</a>. Just enter what is after the "fa-".';
$string['image'] = 'Image';
...
$string['privacy:metadata'] = 'The next_theme theme does not store any personal data about any user.';
...
$string['title'] = 'Title';
$string['titledesc'] = 'To set the title for the this block, enter the block title as plain text or use the "lang" prefix followed by the appropriate "language_key" for multi-lingual support. You can find the theme language keys for multi-lingual support in the "/theme/next_theme/lang/en/theme_next_theme.php" file.';
