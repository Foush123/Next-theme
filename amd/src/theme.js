 ...
 */
 ...
 define(['jquery', 'theme_next_theme/dashboard'], function($, Dashboard) {

    var ThemeNextTheme = function() {
        this.initialize();
    };

    ThemeNextTheme.prototype.initialize = function() {
        ...
        if ($('body').hasClass('pagelayout-mydashboard') || $('.dashboard-container').length > 0) {
            Dashboard.init();
        }
